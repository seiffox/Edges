...
<div class="wp-block-group">
  ...
  <div class="wp-block-group" style="margin-bottom: var(--wp--preset--spacing--70)">
    ...
    <div class="wp-block-group">
      ...
      <h3 class="wp-block-heading has-large-font-size" style="margin-top: var(--wp--preset--spacing--30)">Alexa Liv</h3>
      <!-- /wp:heading -->

      <!-- wp:paragraph {"textColor":"primary","fontSize":"x-small"} -->
      <p class="has-primary-color has-text-color has-x-small-font-size">1.5M Followers</p>
      <!-- /wp:paragraph -->

      <!-- wp:paragraph -->
      <p>Check out our new&nbsp;font generatorand level up your social bios. Need more? Head over to Glyphy for all the&nbsp;fancy fonts&nbsp;and&nbsp;cool symbols&nbsp;you could ever imagine.</p>
      <!-- /wp:paragraph -->
