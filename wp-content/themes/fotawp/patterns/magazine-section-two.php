...
<h1 class="wp-block-heading has-text-align-left has-x-large-font-size" style="margin-bottom:0;line-height:1">News Headline</h1>
<!-- /wp:heading -->
...
<!-- wp:post-author-name {"textColor":"foreground"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
